...
FOLDER_GENERATION_DATA_PATH = str(ROOT_DIR / os.getenv("FOLDER_GENERATION_DATA_PATH", "data/generation"))
FILE_LIST_PATH = str(ROOT_DIR / os.getenv("FILE_LIST_PATH", "data/scraping/article_list.json"))
FILE_CONTENT_PATH = str(ROOT_DIR / os.getenv("FILE_CONTENT_PATH", "data/scraping/article_content.json")) 
